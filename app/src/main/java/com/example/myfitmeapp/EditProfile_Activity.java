...
public class EditProfile_Activity extends AppCompatActivity {
    ...
    public void loadUserProfile() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                /*userHeight.setText(snapshot.child("height").getValue().toString());
                userWeight.setText(snapshot.child("weight").getValue().toString());*/
            }
    ...
    private void Select() {
        CharSequence[] items = {"Update Photo", "Remove Photo"};
    ...
    private void upload() {
        ...
        if (imageUri != null) {
            final StorageReference filePath = FirebaseStorage.getInstance().getReference("profileImages").child(user.getUid() + "/" + UUID.randomUUID().toString());
